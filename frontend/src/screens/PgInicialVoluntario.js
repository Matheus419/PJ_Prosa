...
export default function PgLoginIniciado({navigation, route}) {
            ...
            />
                <View style={styles.mainContent}>
                    ...
                    <View style={styles.actionsContainer}>
                        <Text style={styles.titleProsa2}>Vamos buscar sua prosa?</Text>
                        <TouchableOpacity style={styles.button}>
                            <Text style={styles.buttonText}>Buscar Prosa</Text>  
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={styles.actionsContainer}>
                        ...
                        <TouchableOpacity style={styles.button}>
                            <Text style={styles.buttonText}>Gerenciar Login</Text>  
                        </TouchableOpacity>
                    </View>
                </View>
        </>
